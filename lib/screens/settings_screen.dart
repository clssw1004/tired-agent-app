...
// ═══════════════════════════════════════════════════════════════════════════
// Buffer size tile with dropdown
// ═══════════════════════════════════════════════════════════════════════════

class _BufferSizeTile extends StatelessWidget {
  final int currentSize;
  final ValueChanged<int> onChanged;

  const _BufferSizeTile({
  ...
  Future<void> _showCustomDialog(BuildContext context) {
    return showDialog<void>(
      context: context,
      builder: (_) => _BufferSizeCustomDialog(
...
class _BufferSizeCustomDialog extends StatefulWidget {
  final int initialValue;
  final ValueChanged<int> onSave;

  const _BufferSizeCustomDialog({
    required this.initialValue,
    required this.onSave,
  });

  @override
  State<_BufferSizeCustomDialog> createState() =>
      _BufferSizeCustomDialogState();
}

class _BufferSizeCustomDialogState extends State<_BufferSizeCustomDialog> {
